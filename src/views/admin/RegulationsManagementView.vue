    ...
    setup() {
      ...
      const fetchRegulations = async () => {
        ...
        try {
          ...
          errorMessage.value = 'Không thể tải danh sách quy định. Vui lòng thử lại.';
        } finally {
      ...
      const openEditForm = (regulation) => {
        ...
        formData.useHtml = regulation.useHtml;
      ...
      const saveRegulation = async () => {
        ...
        try {
          ...
          errorMessage.value = 'Không thể lưu quy định. Vui lòng thử lại.';
        } finally {
      ...
      const deleteRegulation = async () => {
        ...
        try {
          ...
          errorMessage.value = 'Không thể xóa quy định. Vui lòng thử lại.';
        } finally {
          isSubmitting.value = false;
        }
      };
